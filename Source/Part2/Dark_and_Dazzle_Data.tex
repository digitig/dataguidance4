...
where:
\begin{quotation}\hl{The use of footnotes for abbreviations doesn't match the style of the rest of the document. Can we use the document convention instead, maybe with a footnote to explain that?}
