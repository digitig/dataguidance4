...
\begin{description}
	...
	\item[Incompleteness:]\index{Completeness!Property} Not all the data that is needed is always available; there may be known, and sometimes, unknown gaps or missing data points. The missing data points (``dark data''\index{Dark Data} -- see \dsiwgExtRef{Section}{2}{bkm:darkdata})
...
The \gls{goldilocks}\index{Goldilocks Property} property is related to the data volume problem discussed in dsiwgRef{Section}{bkm:issues}, however, given the importance of data sizing and the experience of real-world incidents this is now a separate property.
