...
\begin{itemize}
	...
	\item Additional information on data categories \todo{We never seem to explain what we mean by data categories. Consider doing so.}is given in \dsiwgRef{Chapter}{Part2-bkm:categories}.
