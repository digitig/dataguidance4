...
%
%================================================================================
\chapter{Covid-19\index{Covid-19|textbf}} \label{bkm:Covid19}
...
\item The lack of \index{Consistency!Property Handling}\gls{consistency} and standardisation in handling the data, e.g:
  ...
  \item Loss of data (e.g.\ in the UK Test and Trace system due to old versions of Excel\index{Excel})
  \end{enumerate}
