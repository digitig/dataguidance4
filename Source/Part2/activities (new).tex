...
%
%================================================================================
\chapter{Activities (TGR Revised)}\index{Tailoring|textbf}\label{bkm:activities}
...
A data maturity questionnaire (\dsiwgRef{bkm:maturity}) is likely to be useful, particularly when new organizational relationships are being formed. It may offer little value in situations where both organizations are familiar with each other, they have worked on data-related projects together before and there are suitable audit / review arrangements in place.
...
and \dsiwgRef{tab:Likelihood}, while default definitions for severity are presented in Table~\ref{tab:Severity}.
