...
details of which may be found at\todo{Update reference to SSS'26}
...
\item[Part 3] contains the discursive material. It gives background and supporting material intended to improve practitioner's understanding of the data safety management processes and of issues relating to data safety management.
\end{description}
...
\subsection*{Future work}\todo{update future work}
...
\section*{Foreword}\todo{consider whether foreword needs to be repeated in all parts}
...
\clearpage
\section*{Quick Start Guide}\todo{consider whether the quick start guide needs to be included in all parts}
