...
%
%================================================================================
\chapter{Detailed Guidance (Informative)} \label{bkm:guidance}
...
%
  ...
  {+1} & {Trustworthiness}\index{Trustworthiness} & {(Meta) data which tells us how much the system can be trusted}\\\hline
\end{longtable}
...
The following tables detail methods and approaches which may be used by practitioners conducting safety \cbstart management\cbend. The tables map the methods and approaches to data categories. These data categories are abbreviated using the scheme shown in
