...
\longnewglossaryentry{integrity}{
	...
	{\begin{itemize}
			...
			\item The property of protecting the \index{Accuracy Property}\gls{accuracy} and \index{Completeness!Property}\gls{completeness} of assets, i.e., that which has value to the organization. ISO 27001:2013 \cite{citation:ISO27001:2013}
	\end{itemize}}
