...
\begin{longtable}{|C{\dsiwgColumnWidth{0.06}}|L{\dsiwgColumnWidth{0.17}}|L{\dsiwgColumnWidth{0.42}}|L{\dsiwgColumnWidth{0.15}}|}
	\caption{Data Safety Scenarios}
	\label{tab:Scenarios}
	\\\hline\TableHeadColourC{No.} & \TableHeadColour{Name} & \TableHeadColour{Description} & \TableHeadColour{Dev. (D) or maint. (M)}\\\hline
	\endfirsthead
