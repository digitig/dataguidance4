...
%================================================================================
\chapter{Data Migrating, Porting, Importing and Exporting}\index{Data Migration}\label{bkm:migration}
%
...
This chapter highlights some of the issues that arise, links to the data safety properties and suggests some mitigations.
...
\Gls{integrity}\index{Integrity!Property}, \gls{completeness}\index{Completeness!Property}\index{Data Property!Completeness}, \gls{format}\index{Format Property}&
...
\Gls{traceability}\index{Traceability Property}, \gls{history}\index{History Property}&
DM.04, DM.09\\\hline
%
5.&
...
\Gls{consistency}\index{Consistency!Property}, \gls{fidelity}\index{Fidelity Property} &
...
In this case some data may be out of date and become inconsistent (stale), and \gls{integrity}\index{Integrity} of the whole \gls{dataset} is lost.&
Data may be migrated / imported / exported incorrectly.&
\Gls{consistency}\index{Consistency!Property}, \gls{integrity}\index{Integrity!Property}, \gls{timeliness}\index{Timeliness Property}&
DM.07, DM.08\\\hline
%
10.&
...
\Gls{consistency}\index{Consistency!Property}, \Gls{integrity}\index{Integrity!Property}&
