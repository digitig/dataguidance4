...
%
%================================================================================
\chapter{\ecapitalisewords{\glsentrylong{dsmp}}} \label{bkm:plan}
...
\begin{enumerate}
  ...
  \begin{description}
    ...
    \item[Behaviour Monitoring]Identification of measures to monitor the behaviour of the SCS at appropriate intervals throughout its life.
    \item[Change of Use]Identification of procedures to monitor changes of use and for an assurance impact analysis to be undertaken  where necessary.
    \item[Evolution and Incremental Change]Identification of procedures to manage evolution and incremental change of the system.
    \item[Lifetime]Identification of procedures to manage longevity and obsolescence of the data SCS.
    \item[Lessons Learned]Identification of procedures to identify and review lessons learned from successful operation, failures and incidents.
  \end{description}
\item
  Categories
