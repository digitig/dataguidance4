...
\begin{longtable}{|C{\dsiwgColumnWidth{0.06}}|L{\dsiwgColumnWidth{0.17}}|L{\dsiwgColumnWidth{0.5}}|L{\dsiwgColumnWidth{0.17}}|L{\dsiwgColumnWidth{0.1}}|}
	...
	S-0 & %
		...
		\hl{Doesn't seem to be addressed in the guidance} & %
		D %
		\\\hline
	S-1 & Investigate & %
		A safety incident related to data has occurred and the cause of this needs to be understood and	mitigations proposed & %
		\hl{Doesn't seem to be addressed in the guidance} & %
		M %
		\\\hline
	S-2 & %
		New Use & %
		The system using data has changed use and an impact analysis needs to be undertaken & %
		\hl{I don't think any of these are addressed in the current structure. Delete this column?} & M\\
	\hline
