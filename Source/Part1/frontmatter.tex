...
\hl{???Completely rewrite front matter}
...
\gls{sss}'25, 4--6 February 2025\hl{???Update publication event},
...
\hl{???Add SSS'26 dates and publication details}
...
\end{longtable}
%
\subsection*{Changes Since the Last Edition}hl{???Update this whole section}
...
The process remains substantially the same. The intention is that compliance with this version does imply compliance with earlier versions, but some informative material has been made normative so compliance with earlier versions of the guidance does not guarantee compliance with this version.\cbend\
