...
%
%================================================================================
\chapter{Lifecycle Data Categories\index{Category!Data|textbf}} \label{bkm:categories}
...
\autoref{tab:Categories} provides information, in the form of explanations and lists of typical containers, for the identified lifecycle data categories.
...
\multicolumn{5}{|c|}{\dsiwgTextBF{Capability}}\\
  ...
  \hline
  +1 & Trustworthiness\index{Trustworthiness|textbf} & (Meta) data which tells us how much the system can be trusted & Data which provides assurance or confidence about the other data within or about the system under consideration. This might be some of the data mentioned in the other categories, but might be different. & Data audits, \gls{quality} index measures, sign-off sheets, \gls{traceability} records, model \gls{database}\\
  \hline
\end{longtable}
