...
\begin{longtable}{|C{\dsiwgColumnWidth{0.07}}|L{\dsiwgColumnWidth{0.43}}|L{\dsiwgColumnWidth{0.07}}|L{\dsiwgColumnWidth{0.43}}|}
  ...
  \hline
    ...
    \ref{bkm:mac991} & A320-214 Catania incident September 2025 &
...
\begin{longtable}{|C{\dsiwgColumnWidth{0.07}}|L{\dsiwgColumnWidth{0.16}}|L{\dsiwgColumnWidth{0.37}}|L{\dsiwgColumnWidth{0.14}}|L{\dsiwgColumnWidth{0.1}}|L{\dsiwgColumnWidth{0.15}}|}
  ...
  \hline
  %
  \ref{bkm:inacc:mac991} & A320-214 Catania incident September 2025\index[locationidx]{Italy} & Failure to enter takeoff parameters into the \gls{fms} contributed to an unexpected loss of altitude on takeoff.&Flight&2025 &\gls{completeness}\index{Completeness Property}\\
  \hline
  ...
  \gls{accuracy}\index{Accuracy Property}, \gls{fidelity}\index{Fidelity / Representation Property},
  ...
  &
  Space & 1965 & \index{Accuracy Property}\Gls{accuracy},
  ...
  %
	...
	& Air & 2018 \& 2019 & \index{Integrity Property}\Gls{integrity}, \index{Completeness!Property}\gls{completeness}, \index{Accuracy Property}\gls{accuracy}, \index{Availability Property}\gls{availability}, \gls{verifiability}\index{Verifiability Property}, \index{Fidelity / Representation Property}\gls{fidelity}\\ 
	\hline
...
\section{A320-214 Catania incident September 2025}\index[locationidx]{Italy}\label{bkm:inacc:mac991}
...
\Glspl{data property} involved. The performance data not being entered amounted to a loss of the \dsiwgTextIT{\index{Completeness Property}\gls{completeness}}.
...
\end{itemize}
  ...
  % Agincourt - start
  %
\section{Battle of Agincourt}\index[locationidx]{France}\label{bkm:incacc:agincourt}
...
\begin{itemize}
    \item The \gls{mcas}\index{MCAS} system was not described in the pilot's manual and training\index{Training!Personnel} materials (Data Category: Staffing\index{Staffing Data}, \index{Property!Data}Properties lost: \dsiwgTextIT{\index{Availability Property}\gls{availability}})
...
This incident highlights the importance of three \index{Property!Data}\glspl{data property}: \index{Accuracy Property}\gls{accuracy}; \dsiwgTextIT{\gls{timeliness}\index{Timeliness Property}}; and \dsiwgTextIT{\gls{verifiability}}\index{Verifiability Property}. All of these apply to data describing the runway's location.
...
This incident highlights the importance of the \index{Accuracy Property}\gls{accuracy} \index{Property!Data}\gls{data property}, with regards to the \gls{information} displayed on the electronic chart. It also highlights the importance of the \dsiwgTextIT{\index{Completeness!Property}\gls{completeness}} \index{Property!Data}\gls{data property}, with regards to training\index{Training!Personnel} (and training\index{Training!Personnel} records) and the \dsiwgTextIT{\gls{intended_destination}} \index{Property!Data}\gls{data property}, with regards to the inappropriate use of the \gls{vms} data.
