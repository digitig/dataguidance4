...
\begin{longtable}{|L{\dsiwgColumnWidth{0.05}}L{\dsiwgColumnWidth{0.45}}|C{\dsiwgColumnWidth{0.08}}|C{\dsiwgColumnWidth{0.08}}|C{\dsiwgColumnWidth{0.08}}|C{\dsiwgColumnWidth{0.08}}|C{\dsiwgColumnWidth{0.08}}|}
  ...
  \multicolumn{6}{|c|}{\dsiwgTextBF{Identify Risks}}\\ \hline
	...
	2-3 & Unintended behaviours resulting from missing or hidden data shall be identified and analysed. & & & & & \\ \hline
	2-4 & Risks SHALL be identified and linked to \glspl{data artefact}\index{Artefact, Data} and \index{Property!Data}\glspl{data property}. & X & X & & X & \\ \hline
