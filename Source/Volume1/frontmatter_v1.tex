...
% When reference is made to the content of other volumes, this is indicated by the volume number followed by the reference within that volume in parentheses. So ``\dsiwgExtRef{Chapter}{3}{bkm:accidents}'' refers to chapter \ref*{Part3-bkm:accidents} in volume 3.
...
\begin{description}
	...
	\item[Volume 3] contains the discursive\index{Discursive Text} material. It describes the ``why'' of the guidance and gives background and supporting material intended to improve practitioner's understanding of the data safety management processes and of issues relating to data safety management.
\end{description}
	
\begin{itemize}
	\item The data properties that need to be guaranteed to ensure system safety are described in \dsiwgRef{Chapter}{bkm:dataProperties}
	\item The underlying principles of the guidance are described in \dsiwgRef{Chapter}{bkm:principles}.
	\item The objectives and outputs to satisfy the principles are described in \dsiwgRef{Chapter}{bkm:objectives}.
	\item Definitions and abbreviations are described in \dsiwgRef{Chapter}{bkm:definitionsabbreviations}.
	...
	\item Lifecycle considerations are addressed in \dsiwgExtRef{Chapter}{3}{bkm:lifecycle}.
	\item The data safety tool RADISH is described in \dsiwgExtRef{Chapter}{3}{bkm:radish}.
	\item Some of the data issues that made management of the Covid-19 virus difficult are discussed in \dsiwgExtRef{Chapter}{3}{bkm:Covid19}.
	\item A summary of accidents and incidents in which data was potentially a causal factor is given in Chapter \dsiwgExtRef{Chapter}{3}{bkm:accidents};
\end{itemize}
