...
\item When looking to the risks of tools, it is not sufficient to consider only the functional risks like ``wrong data created''
  ...
  (\dsiwgRef{Subsection}{bkm:issues} Ways that Data Can Cause  Problems) should be considered for impact from the tools.
  ...
  \begin{itemize}
  \item Each issue listed in \dsiwgRef{Subsection}{bkm:issues}; and
