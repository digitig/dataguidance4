...
\begin{itemize}
  \item which \glspl{dataset} or \glspl{item data}\ being received from other systems have \index{Data Property}\glspl{data property} (such as \gls{timeliness}\index{Timeliness Property}, \index{Completeness!Property}\gls{completeness}, \index{Consistency!Property}\gls{consistency}, \index{Fidelity Property}\gls{fidelity} etc.) that are significant to patient safety? 
  \item what data presented to the user has \index{Data Property}\glspl{data property} (such as \index{Availability Property}\gls{availability}, format\index{Format Property}, \gls{resolution}\index{Resolution Property}, etc.) that are significant to patient safety?
