...
\todo{Completely rewrite front matter}
...
\gls{sss}'25, 4--6 February 2025\todo{Update publication event},
...
\todo{Add SSS'26 dates and publication details}
...
\todo{Update future work}
\todo{Consider whether future work needs to be included in all parts}
...
These improvements are intended to clarify the application of the data safety process\todo{Review future work}
and include:
\begin{itemize}
...
\todo{Revise quick start guide for new structure}
