...
\subsection{Abstraction, Hierarchy and Flowdown}\label{bkm:abstraction}
It is useful to consider different levels of abstraction of the system and also the data used within the system. An abstraction model of the system and its data enables reasoning and communication of the assurance requirements, and supports flowdown of the assurance requirements. Moreover it allows clearer reasoning about its safety. Many design approaches and tools support hierarchical views and these can be used as needed. When a hierarchical design is constructed it is possible to apply requirements and \glspl{dsal} at the top level and flow these down, decomposing as needed to lower levels of design or abstraction. Tools can support tracing of requirements through design hierarchies.
