...
\begin{itemize}
  \item The Covid-19 Track and Trace data loss (Part 2 Section~\ref*{Part2-bkm:incacc:covidexcel}), where the organisation handling the data was unaware that rows were missing from a spreadsheet for some time is illustrated in \autoref {fig:darknewcases}
