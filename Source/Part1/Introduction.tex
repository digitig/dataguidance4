...
\todo{consider whether the introduction needs to be included in all parts (normative, informative and discursive, perhaps and shall, should, may, but they should be in definitions anyway)}
...
\section{Normative, Informative and Discursive Text}\todo{Consider whether this is relevant to Part 2}
