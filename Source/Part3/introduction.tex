...
\hl{???Consider whether the introduction needs to be included in all parts}
...
\begin{description}
	...
	\item[SHOULD] denotes items where, in some circumstances, there may be valid reasons for not conforming with a particular item. The full implications of non-conforming must be understood, documented and approved in order to claim conforming with this guidance document.
