...
%--------------------------------------------------------------------------------
\usepackage{array}              %Automation of column widths
%--------------------------------------------------------------------------------
...
\usepackage[                    %Could use \hypersetup but easier to do it here
  ...
  linktoc=page,
  hyperindex=false % Suppress index hyperlinks because they won't work between documents
...
\newcommand{\dsiwgExtRef}[3]{Vol. #2 {#1} \ref*{Part#2-#3}}
%
...
% Allow selected captions to be excluded from tables
\usepackage{caption}
