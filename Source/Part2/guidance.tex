...
%
%================================================================================
\chapter{Guidance (Informative)} \label{bkm:guidance}
...
\autoref{bkm:assessment} presents an \gls{odr} assessment form capture a high-level perspective on the risk posed to an organization by data safety issues within a specific project. How the assessment integrates with an organization's existing risk (or safety) management processes is the responsibility of the implementing organization. Ihe form could be used to help tailor the data safety process. The following paragraphs describe the connections between the \gls{odr} and the
...
Questions 2, 3 and 4 of the \gls{odr} align directly with activity 6.3.3 from \gls{iso} 31000: establishing the external context of the risk assessment.
...
\subsection{Data Categories\index{Category!Data|textbf}}
...
\autoref{tab:CategoriesShort} gives the current view of the categories of safety-related data that contribute to, are used by, produced by, or affected by safety-related systems. They are roughly organized into a number of categories\index{Category!Data}, which aim to cover all aspects of the system lifecycle\index{Lifecycle!System}. The list in \autoref{tab:CategoriesShort} is not exhaustive. A more detailed version of this table is given in \autoref{bkm:categories}.
...
\begin{longtable}{|C{\dsiwgColumnWidth{0.1}}|L{\dsiwgColumnWidth{0.2}}|L{\dsiwgColumnWidth{0.7}}|}
  ...
  {13} & {Staffing}\index{Staffing Data} & {Data related to staff training\index{Training!Personnel}, competency, certification and permits}\\\hline
...
\subsection{Ways that Data Can Cause Problems}
\label{tab:issues}
...
\subsection{\ecapitalisewords{\glsentryplural{data property}}}\label{bkm:guidance:dataproperties}
...
%
\subsubsection{The \glsfmttext{analysability}\index{Analysability Property|textbf} property}\label{bkm:guidance:analysability}
...
\subsubsection{The \glsfmttext{explainability}\index{Explainability Property|textbf} property}\label{bkm:guidance:explainability}
...
\begin{longtable}{|L{\dsiwgColumnWidth{0.24}}|C{\dsiwgColumnWidth{0.15}}|L{\dsiwgColumnWidth{0.61}}|}
  ...
  {\Gls{analysability}\index{Analysability Property}} & Z & {The data (including any \gls{metadata}) is of a suitable size, type and format to enable it be usefully analysed}\\\hline
  ...
  {\Gls{clarity}\index{Clarity Property}} & K & {The data is visible, unmasked, not hidden or obscured and not camouflaged}\\\hline
\end{longtable}
...
\begin{longtable}{|L{\dsiwgColumnWidth{0.15}}|%
  ...
  & \rotatebox{90}{\Gls{clarity}\index{Clarity Property}}
  %
  ...
  \endfirsthead
    ...
    & \rotatebox{90}{\Gls{resolution}\index{Resolution Property}}
    & \rotatebox{90}{\Gls{traceability}\index{Traceability Property}}
    & \rotatebox{90}{\Gls{timeliness}\index{Timeliness Property}}
    & \rotatebox{90}{\Gls{verifiability}}\index{Verifiability Property}
    & \rotatebox{90}{\index{Availability Property}\Gls{availability}}
    & \rotatebox{90}{\Gls{fidelity}\index{Fidelity / Representation Property}}
    & \rotatebox{90}{\Gls{priority}} 
    & \rotatebox{90}{\Gls{sequencing}\index{Sequencing, Data}}
    & \rotatebox{90}{\Gls{intended_destination}\index{Intended Destination / Usage Property}\ }
    & \rotatebox{90}{\Gls{accessibility}\index{Accessibility Property}}
    & \rotatebox{90}{\Gls{suppression}\index{Suppression Property}}
    & \rotatebox{90}{\Gls{history}\index{History Property}}
...
The list is non-exhaustive. Other guidewords may be useful for particular systems or may be used to ensure the data safety assessment is fully integrated within the system safety assessment\index{Safety Assessment!System}\index{System Safety Assessment|see{Safety Assessment, System}}. A more detailed version of this table, including specific \gls{hazop}\index{HAZOP} data considerations, is available at \autoref{bkm:guidewords}.
...
\begin{longtable}{|L{\dsiwgColumnWidth{0.25}}|L{\dsiwgColumnWidth{0.75}}|}
  ...
  {\Gls{completeness}}\index{Completeness!Property} & {Loss, partial loss, incorrect, multiple, insufficient, missing, hidden, unknown, obscured}\\\hline
  ...
  {\Gls{continuity}}\index{Continuity Property} & {Loss, partial loss, incorrect, late, loss of sequence, missing, hidden, unknown, obscured}\\\hline
  ...
  {\Gls{availability}}\index{Availability Property} & {Loss, partial loss, multiple, too early, too late, missing, hidden}\\\hline
  ...
  {\Gls{clarity}\index{Clarity Property}} & { Camouflaged, hidden, obscured, masked, invisible, dark, indistinct, noisy}\\\hline
\end{longtable}
...
The following tables detail methods and approaches which may be used by practitioners conducting \index{Safety Assessment}safety assessments. The tables map the methods and approaches to data categories. These data categories are abbreviated using the scheme shown in
...
The tables also map the methods and approaches to the \index{Property!Data}\glspl{data property}. The properties
which were defined in \autoref{tab:PropertiesOfData} have been assigned abbreviations, shown in that table.
...
\begin{itemize}
    \item Determine the \gls{dsal}\index{Assurance Level!Data} applicable to the \index{Artefact, Data}\gls{data artefact}, using Part 1 Table~\ref*{Part1-tab:DSAL-risk-matrix} in association with \autoref{tab:Likelihood} and \autoref{tab:Severity}.
...
\begin{itemize}
    \item the data category\index{Category!Data} matches the data category\index{Category!Data} for this \index{Artefact, Data}\gls{data artefact}; and
    \item at least one of the \index{Property!Data}\glspl{data property} listed in that row matches a \index{Property!Data}\gls{data property} for the \gls{data artefact} 
\end{itemize}
then the row is likely to be applicable to the \index{Artefact, Data}\gls{data artefact}. The result for that row is therefore found from the \gls{dsal}\index{Assurance Level!Data} column, since if:
\begin{itemize}
...
\begin{longtable}
  ...
  \hline
  DD.08 & \Gls{data dictionary} & \dsiwgTextTT{VIDPJ} & HR & HR & HR & HR & A collection of descriptions of the data objects or \glspl{item data} in a data model for the benefit of data users. & \dsiwgTextTT{..N.O.R....F.........ZX}\\
  \hline
