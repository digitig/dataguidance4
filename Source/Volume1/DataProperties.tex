...
The \gls{goldilocks}\index{Goldilocks Property}\index{Data Property!Goldilocks} property is related to the data volume problem discussed in \dsiwgExtRef{Section}{3}{bkm:issues}, however, given the importance of data sizing and the experience of real-world incidents this is now a separate property.
%
