...
%
%================================================================================
\cbstart\chapter{Activities (Informative)}\index{Tailoring|textbf}\label{bkm:activitiestailoring}\cbend
...
Part of this activity involves understanding the system \index{Stakeholder}\glspl{stakeholder}. It is important to define how the \index{Stakeholder}\glspl{stakeholder} will interact, determine the derived requirements applicable to each \index{Stakeholder}\gls{stakeholder}, and identify how these requirements will be managed through organisational interface control\index{Interface!organizational} (similarly to systems engineering interface control procedures already in place in many industries). External factors (e.g., economic, social, regulatory) and internal factors (e.g., cultural, processes, strategic) are key to defining appropriate organisational interface control measures. Organisational interface control may be iterative throughout the \cbstart data safety management process\cbend. In particular, organisational interface control may need to be amended to take account of implemented data safety \glspl{mitigation}\index{Mitigation}.
...
Planning of the \cbstart data safety management\cbend\ may be done through a procurement process. Procurers may wish to know their potential supplier's understanding of data safety and their plans to implement a \index{Safety Assessment!Data}\gls{safety assessment}. A data safety supplier questionnaire is given in Section\ref{bkm:maturity} and may be used to determine the potential supplier's understanding and plans, and for auditing purposes.
...
Including data safety within a project safety management plan is recommended for complex or highly safety-critical systems. In this case the structure of the safety management plan may be maintained, with the \index{Safety Assessment!Data}\gls{safety assessment} process being tailored to align to the overall \cbstart safety management process\cbend.

\cbstart A data maturity questionnaire \todo{Reference questionnaire when it's in its final location} is likely to be useful, particularly\cbend\ when new organizational relationships are being formed. It may offer little value in situations where both organizations are familiar with each other, they have worked on data-related projects together before and there are suitable audit / review arrangements in place.
...
Part 3 Section~\ref{Part3-bkm:accidents}. Each domain might have its own catalogue of historical incidents, which can be consulted during a data-focused review. Some organisations carry out a ``lessons learned'' review at the end of projects, which can also give insight into potential risks.
...
\subsection{Overview}
This part of the risk management process involves developing an understanding of the consequences and likelihood of each risk. This understanding allows system (or safety) \gls{integrity} levels or \index{Assurance Level!Development}development assurance levels to be determined.
%
