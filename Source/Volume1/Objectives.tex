...
%
%================================================================================
\chapter{Objectives \label{bkm:objectives}}
...
The data safety assurance principles (Chapter \ref{bkm:principles}) provide the underpinning philosophy for this guidance. Conformance to this guidance could be based around these principles. This section identifies the objectives to satisfy the principles.
...
The objectives and outputs supporting this principle are shown in Table \ref{tab:p1_principles}.
\begin{longtable}{|C{\dsiwgColumnWidth{0.06}}|L{\dsiwgColumnWidth{0.29}}|L{\dsiwgColumnWidth{0.29}}|L{\dsiwgColumnWidth{0.2}}|}
	...
	1.a &%
	  ...
	  & \dsiwgExtRef{Section}{2}{bkm:establishcontext}%
	  \\\hline
	1.b & %
	...
	1.d & % 
	  ...
	  \\\hline
	1.e & %
	  Data safety \index{Artefact!Data|(}artefacts SHALL be identified &%
	...
	1.f & %
	  ...
	  A list of risks, linked to data artefacts and data properties; A description of the process used for risk identification & %
		\dsiwgExtRef{Section}{2}{bkm:identifyrisks} %
		\\\hline
	1.g & %
	  ...
	  \dsiwgExtRef{Chapter}{2}{bkm:activities} %
	  \\\hline
	1.h & %
	...
	1.i & %
	  ...
	  \dsiwgExtRef{Chapter}{2}{bkm:darkdazzledata} %
	  \\\hline
	1.j & %
	...
	1.l & %
	  ...
	  \dsiwgExtRef{Chapter}{2}{bkm:guidance} %
	  \\\hline
	1.m & %
	  \glspl{dsal} SHALL be established and justified.&%
	  A list of \glspl{dsal} assigned to components and their justifications.&%
	  \dsiwgExtRef{Chapter}{2}{bkm:guidance} %
	  \\\hline
	1.n &%
	The risk appetite of stakeholders regarding data risks SHALL be established.&%
	The \gls{dsmp}&
	\dsiwgExtRef{Appendix}{2}{bkm:plan}%
	\\\hline
	 \end{longtable}
\cbend
...
\begin{longtable}{|C{\dsiwgColumnWidth{0.06}}|L{\dsiwgColumnWidth{0.39}}|L{\dsiwgColumnWidth{0.39}}|L{\dsiwgColumnWidth{0.16}}|}
	...
	2.a & %
	  ...
	  \dsiwgExtRef{Subsection}{2}{bkm:abstraction}%
      \\\hline
	2.b &%
	...
	2.e &%
	  ...
	  Interactions report. &%
	  \dsiwgExtRef{Appendix}{2}{bkm:interactions}%
	  \\\hline
	2.f &%
	...
	2.i &%
	  ...
	  \dsiwgExtRef{Chapter}{2}{bkm:tools}%
	  \\\hline
\end{longtable}
\cbend
...
\begin{longtable}{|C{\dsiwgColumnWidth{0.06}}|L{\dsiwgColumnWidth{0.39}}|L{\dsiwgColumnWidth{0.39}}|L{\dsiwgColumnWidth{0.16}}|}
   ...
   \dsiwgExtRef{Chapter}{2}{bkm:guidance}; \dsiwgExtRef{Appendix}{2}{bkm:plan}%
	  \\\hline
	3.b &
	...
	3.c &%
	   ...
	   A description of the addition processes, methods and tools which provide backing assurance.& %
	   \dsiwgExtRef{Appendix}{2}{bkm:plan}%
	   \\\hline
	3.d &%
	  \Glspl{dsal} SHALL be satisfied. &%
	  Conformance to \glspl{dsal} by reference to the mitigation tables.&%
	  \dsiwgExtRef{Section}{2}{bkm:EvaluateAndTreat}%
	  \\\hline
	3.e &%
	  Trusted tools SHALL be used to produce verification evidence &%
	  Tools used to produce verification evidence should be appropriately qualified and justified.&%
	  \dsiwgExtRef{Chapter}{2}{bkm:tools}\\\hline
	3.f &%
	  Verification evidence SHOULD include evidence acquired from field or historical usage where available &%
	  Ideally, real-world usage evidence should be used to support verification. The usage scenarios SHOULD accurately reflect the intended usage of the system being verified.&%
	  External%
	  \\\hline
	3.g &%
	  Conformance with data safety requirements SHALL be documented.&%
	  Conformance matrix & %
	  Normal engineering process%
	  \\\hline
	3.h &%
	  Data safety requirements which are partially or not met SHALL be identified and justified &%
	  &%
	  Normal engineering process%
	  \\\hline
	3.i &%
...
The objectives and outputs supporting this principle are shown in Table \ref{tab:p4_principles}.
\begin{longtable}{|C{\dsiwgColumnWidth{0.06}}|L{\dsiwgColumnWidth{0.39}}|L{\dsiwgColumnWidth{0.39}}|L{\dsiwgColumnWidth{0.16}}|}
	...
	4.a &%
	  ...
	  \dsiwgExtRef{Appendix}{2}{bkm:interactions}. Future work to develop this further.%
	  \\\hline
	4.b &%
	  Unintended behaviour resulting from data SHALL be identified, analysed and addressed.&%
	  Unintended Behaviours Report. &%
	  \dsiwgExtRef{Appendix}{2}{bkm:unintended} and \dsiwgExtRef{Appendix}{2}{bkm:interactions}%
	  \\\hline
	4.c & Unintended behaviour resulting from
      hidden or absent data SHALL be identified and analysed. &%
      Unintended Behaviours Report.&%
	  \dsiwgExtRef{Appendix}{2}{bkm:unintended} and
	  \dsiwgExtRef{Chapter}{2}{bkm:darkdazzledata}%
	  \\\hline
	4.d &%
...
\begin{longtable}{|C{\dsiwgColumnWidth{0.06}}|L{\dsiwgColumnWidth{0.39}}|L{\dsiwgColumnWidth{0.39}}|L{\dsiwgColumnWidth{0.16}}|}
	...
	\hline
	5.a & %
	  \Glspl{dsal} SHALL be appropriately applied.&%
	  The application and conformance to \glspl{dsal} needs to be appropriate for the level of risk presented by the system.&%
	  \dsiwgExtRef{Chapter}{2}{bkm:activities} and \dsiwgExtRef{Section}{2}{bkm:EvaluateAndTreat}%
	  \\\hline
	5.b &%
	  Assurance artefacts\index{Artefact!Assurance} SHALL be produced with a level of rigour commensurate with the \gls{dsal} and data safety requirements.&%
	  Artefacts used to demonstrate the safety of the system need  to be produced in an appropriate way for the system risk.&%
	  \dsiwgExtRef{Chapter}{2}{bkm:activities} and \dsiwgExtRef{Section}{2}{bkm:EvaluateAndTreat}%
	  \\\hline
	5.c &%
	  ...
	  This is addressed in the \gls{smp}.&%
	  \dsiwgExtRef{Appendix}{2}{bkm:plan} and \dsiwgExtRef{Chapter}{2}{bkm:tools}%
	  \\\hline
	5.d &%
	  Specific confidence demands from stakeholder groups  regarding data SHALL be addressed.&%
	  This is addressed in the \gls{smp}&%
	  \dsiwgExtRef{Appendix}{2}{bkm:plan}%
	  \\\hline
	5.e &%
	  Residual risks regarding conformance to the data safety principles SHALL be documented. &%
	  Residual conformance risks would typically be recorded in an overall system safety justification document such as a safety case.&%
	  External%
	  \\\hline
  \end{longtable}
\cbend
...
\section{Principle 6}
\dsiwgTextBF{\dsiwgTextIT{All principles SHALL be established and maintained through all changes, reuse, re-deployment and re-purposing.}}
...
\begin{longtable}{|C{\dsiwgColumnWidth{0.06}}|L{\dsiwgColumnWidth{0.39}}|L{\dsiwgColumnWidth{0.39}}|L{\dsiwgColumnWidth{0.16}}|}
	...
	6.a &%
	  ...
	  The \gls{dsmp} continues to apply through system life.&%
	  \dsiwgExtRef{Appendix}{2}{bkm:plan}
	  \\\hline
    6.b &%
      Assurance artefacts\index{Artefact!Assurance} SHALL be maintained.&%
      The \gls{dsmp} continues to apply through system life.&%
      \dsiwgExtRef{Appendix}{2}{bkm:plan}
      \\\hline
    6.c &%
