...
%
%================================================================================
\chapter{Data Safety Management Process} \label{bkm:process}
...
in due course, their safety management system, a possible outline data safety management process has been developed, which could be blended with the principles and objectives described in Volume 1 (\dsiwgExtRef{Chapter}{1}{bkm:principles} and \dsiwgExtRef{Chapter}{1}{bkm:objectives}).
...
Links between the process objectives and the assurance principles are described in \dsiwgExtRef{Chapter}{1}{bkm:objectives}. The
...
objectives and outputs of each step are described in more detail in Section~\autoref{bkm:activities}. The last outcome of the
...
Further examples of system lifecycles are given in \dsiwgExtRef{Chapter}{3}{bkm:lifecycle}.
...
categories are covered in more detail in \autoref{bkm:categories}.

\autoref{fig:process} shows the types of data that are of concern for each process step, including those that apply to all steps, and how these feed into the \gls{data safety assessment}\index{Safety Assessment!Data} process.
