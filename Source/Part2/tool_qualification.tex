...
\item When looking to the risks of tools, it is not sufficient to consider only the functional risks like ``wrong data created''
  ...
  (Subsection~\ref*{tab:issues} Ways that Data Can Cause  Problems) should be considered for impact from the tools.
  ...
  \begin{itemize}
  \item Each issue listed in Subsection~\ref*{tab:issues}
  \item Each Property listed in Table \ref*{tab:PropertiesOfData}
  \end{itemize}    
\end{itemize}
