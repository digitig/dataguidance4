...
Subsection~\ref{bkm:Establishing-DSALS}\index{Assurance Level!Data}
and Table~\ref{tab:Likelihood}, while default definitions for severity are presented in Table~\ref{tab:Severity}.
