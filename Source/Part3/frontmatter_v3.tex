...
\item the inclusion of an appendix (\hyperref[bkm:autonomy]{{Appendix}~\ref{bkm:autonomy}}) on \glsxtrshort{ai} and autonomy; and
...
When reference is made to the content of other volumes, this is indicated by the volume number shown in bold text. So ``\dsiwgExtRef{Chapter}{2}{Part2-bkm:activities}'' refers to chapter \ref*{Part2-bkm:activities} in volume 2.
...
\begin{description}
	...
	\item[Volume 3] (this volume) contains the discursive material. It describes the ``why'' of the guidance and gives background and supporting material intended to improve practitioner's understanding of the data safety management processes and of issues relating to data safety management.
\end{description}
...
\begin{itemize}
	...
	\item A worked example is provided in Chapter \dsiwgExtRef{Chapter}{2}{bkm:workedexample}.
	\item Guidance for the assignment of \glspl{dsal} is given in \dsiwgExtRef{Chapter}{2}{bkm:DsalCustomisation}.
	\item Examples of ways that \glspl{dsal} may be customised, with particular focus on likelihood are given in \dsiwgExtRef{Chapter}{2}{bkm:tools}.
	...
	\item Lifecycle considerations are addressed in \dsiwgRef{Chapter}{Part3-bkm:lifecycle}.
	\item The data safety tool RADISH is described in \dsiwgRef{Chapter}{Part3-bkm:radish}.
	\item Some of the data issues that made management of the Covid-19 virus difficult are discussed in \dsiwgRef{Chapter}{Part3-bkm:Covid19}.
	\item A summary of accidents and incidents in which data was potentially a causal factor is given in Chapter \dsiwgRef{Chapter}{Part3-bkm:accidents};
	\cbend
\end{itemize}
%
% Table of Contents
