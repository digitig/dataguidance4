...
\longnewglossaryentry{integrity}{
	...
	{\begin{itemize}
			...
			\item The property of protecting the \index{Data Property!Accuracy}\index{Accuracy Property}\gls{accuracy} and \index{Completeness!Property}\gls{completeness} of assets, i.e., that which has value to the organization. ISO 27001:2013 \cite{citation:ISO27001:2013}
	\end{itemize}}
...
\longnewglossaryentry{quality}{
	...
	text={data quality}}%
	{\begin{itemize}
			\item A degree or level of confidence that the data provided meet the requirements of the user. These requirements include levels of \gls{accuracy}\index{Data Property!Accuracy}\index{Accuracy Property|see {Data Property, Accuracy}}, \gls{resolution}\index{Resolution Property}, \cbstart\gls{dsal}\cbend\index{Assurance Level}, \gls{traceability}\index{Traceability Property}, timeliness\index{Timeliness Property}, \gls{completeness}\index{Completeness!Property}, and format. RTCA/DO-200A \cite{citation:ED76}
			\item A degree or level of confidence that the data provided meets the requirements of the data user in terms of \index{Data Property!Accuracy}\index{Accuracy Property|see {Data Property, Accuracy}}\gls{accuracy}, \gls{resolution}\index{Resolution Property} and \index{Integrity!Property}\gls{integrity}. (EU) No 73/2010 \cite{citation:EU732010}
	\end{itemize}}
