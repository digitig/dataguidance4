...
Three data categories are discussed: \cbstart\gls{ml} training\index{Training!AI} data\index{Machine Learning Data} (the data used to train the model)\cbend,
