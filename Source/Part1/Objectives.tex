...
\begin{longtable}{|C{\dsiwgColumnWidth{0.06}}|L{\dsiwgColumnWidth{0.39}}|L{\dsiwgColumnWidth{0.39}}|L{\dsiwgColumnWidth{0.16}}|}
	...
	\multirow{2}{*}{1.f} & %
	  ...
	  A list of risks, linked to data artefacts and data properties. & \\\cline{3-4} %
	 & & %
...
The objectives and outputs supporting this principle are shown in Table \ref{tab:p4_principles}.\todo{consider whether it's appropriate to refer to Black swan data, etc, which are not normatively defined.}
\begin{longtable}{|C{\dsiwgColumnWidth{0.06}}|L{\dsiwgColumnWidth{0.39}}|L{\dsiwgColumnWidth{0.39}}|L{\dsiwgColumnWidth{0.16}}|}
