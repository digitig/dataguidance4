...
\newacronym{ansv}{ANSV}{Agenzia nazionale per la sicurezza del volo (Italian civil aviation safety investigation authority)}
...
\newacronym{conops}{CONOPS}{Concept of Operation}
...
\newacronym{fmeca}{FMECA}{Failure mode and criticality analysis}
...
\newacronym{swift}{SWIFT}{structured what-if checklist}
%T
...
\newglossaryentry{data owner}{
	...
	name={owner, data},
	text={data owner},
	description={Person having responsibility and authority for the data. \cite{citation:iso25642}}
}
...
\newglossaryentry{data safety assessment}{
	...
	description={The process of explicitly considering data as part of system safety assessment, via the means of \glspl{data artefact}, Data Properties and \glspl{dsal}.}
}
...
\newglossaryentry{accuracy}{
	name={accuracy},
	plural={accuracies},
	description={Closeness of agreement between a measured quantity value and a true quantity value of a measurand. \cite{citation:iso25642}}
}
...
\newglossaryentry{aliasing}{
	name={aliasing},
	description={An effect that causes different data to become indistinguishable when accessed}
}

\newglossaryentry{clarity}{
    name={clarity},
	description={The property that the data is visible, unmasked, not hidden or obscured, and not camouflaged}}
...
\newglossaryentry{black swan data}{
	name={black swan data},
	description={Data that is totally unexpected by those receiving it.}
}
...
\longnewglossaryentry{critical data}{
	...
	{\begin{itemize}
			...
			\item Data with an \index{Integrity Property}\index{Data Property!Integrity}\gls{integrity} level as defined in Chapter 3, Section 3.2 point 3.2.8(a) of Annex 15 to the Chicago Convention, i.e., \index{Integrity Property}\index{Data Property!Integrity}\gls{integrity} level one in one hundred million: there is a high probability when using corrupted critical data that the continued safe flight and landing of an aircraft would be severely at risk with the potential for catastrophe. (EU) No 73/2010 \cite{citation:EU732010}
	\end{itemize}}
...
\newglossaryentry{dragon king data}{name={dragon king data},description={Data whose effect might have been foreseen, but that leads to an unexpected escalation with major impact}}
...
\newglossaryentry{format}{name={format}, description={The property that data is represented in a way which is readable by those that need to use it.}}
...
\longnewglossaryentry{integrity}{
	...
	{\begin{itemize}
			...
			\item The property of protecting the \index{Data Property!Accuracy}\index{Accuracy Property}\gls{accuracy} and \index{Completeness Property}\index{Data Property!Completeness}\gls{completeness} of assets, i.e., that which has value to the organization. ISO 27001:2013 \cite{citation:ISO27001:2013}
	\end{itemize}}
...
\newglossaryentry{perfect storm data}{name={perfect storm data},description={Combinations, sets or occurrences of data (or absences of data) that would never have been thought possible to occur together, and when they do have a large and undesirable impact.}}
...
\newglossaryentry{Pudding Lane data}{name={Pudding Lane data},description={Data that is unknowingly and unexpectedly critical to the whole operation and if missing or incorrect in some way, has a dramatic and negative impact. After the event it may be obvious that it was critical.}}

\longnewglossaryentry{quality}{
	name={quality, data},
	text={data quality}}%
	{\begin{itemize}
			\item A degree or level of confidence that the data provided meet the requirements of the user. These requirements include levels of \gls{accuracy}\index{Data Property!Accuracy}\index{Accuracy Property}, \gls{resolution}\index{Resolution Property}, \cbstart\gls{dsal}\cbend\index{Assurance Level}, \gls{traceability}\index{Traceability Property}, timeliness\index{Timeliness Property}, \gls{completeness}\index{Completeness Property}\index{Data Property!Completeness}, and format. RTCA/DO-200A \cite{citation:ED76}
			\item A degree or level of confidence that the data provided meets the requirements of the data user in terms of \index{Data Property!Accuracy}\index{Accuracy Property}\gls{accuracy}, \gls{resolution}\index{Resolution Property} and \index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}. (EU) No 73/2010 \cite{citation:EU732010}
	\end{itemize}}
...
\newglossaryentry{routine data}{
	name={routine data},
	description={data with an \index{Integrity Property}\index{Data Property!Integrity}\gls{integrity} level as defined in Chapter 3, Section 3.2 point 3.2.8(b) of Annex 15 to the Chicago Convention, i.e., \index{Integrity Property}\index{Data Property!Integrity}\gls{integrity} level one in one thousand: there is a very low probability when using corrupted routine data that the continued safe flight and landing of an aircraft would be severely at risk with the potential for catastrophe. (EU) No 73/2010 \cite{citation:EU732010}}
}

\longnewglossaryentry{safety}{
	name = {safety}}%
	{\begin{itemize}
			\item The state of being protected from or guarded against hurt or injury; freedom from danger. \gls{oed}
			\item Freedom from conditions that can cause death, injury, occupational
				illness, damage to or loss of equipment or property, or damage to the environment. \cite{citation:milstd882}
	\end{itemize}}
