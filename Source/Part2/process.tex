...
Links between the process objectives and the assurance principles are described in Part~1 Section \ref*{Part1-bkm:principlesobjectives}. The
...
objectives and outputs of each step are described in more detail in Part 1 Section~\autoref{Part1-bkm:activitiestailoring}. The last outcome of the
