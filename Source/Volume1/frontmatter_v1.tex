...
\hl{???This part needs rewriting when structure is stable}
\begin{itemize}
	...
	\item The activities of each phase (and associated \gls{tailoring} \gls{information}) are described in \dsiwgExtRef{Chapter}{2}{Part2-bkm:activities}.
	\item A worked example is provided in Chapter \ref*{Part2-bkm:workedexample}.
	\item Guidance for the assignment of \glspl{dsal} is given in \dsiwgExtRef{Chapter}{2}{Part2-bkm:DsalCustomisation}.
	\item Examples of ways that \glspl{dsal} may be customised, with particular focus on likelihood are given in \dsiwgExtRef{Chapter}{2}{Part2-bkm:tools}.
	\item Issues relating to \gls{ai} and \gls{ml} are considered in \dsiwgExtRef{Chapter}{2}{Part2-bkm:MachineLearning} and \dsiwgExtRef{Chapter}{2}{Part2-bkm:autonomy}.
	\item Additional information on data categories \todo{We never seem to explain what we mean by data categories. Consider doing so.}is given in \dsiwgExtRef{Chapter}{2}{Part2-bkm:categories}.
	\item Issues that may arise when migrating, porting, importing or exporting data are discussed in \dsiwgExtRef{Chapter}{2}{Part2-bkm:migration}).            
	\item Lifecycle considerations are addressed in \dsiwgExtRef{Chapter}{3}{Part3-bkm:lifecycle}.
	\item The data safety tool RADISH is described in \dsiwgExtRef{Chapter}{3}{Part3-bkm:radish}.
	\item Some of the data issues that made management of the Covid-19 virus difficult are discussed in \dsiwgExtRef{Chapter}{3}{Part3-bkm:Covid19}.
	\item A summary of accidents and incidents in which data was potentially a causal factor is given in Chapter \dsiwgExtRef{Chapter}{3}{Part3-bkm:accidents};
\end{itemize}
