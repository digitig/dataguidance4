...
When reference is made to the content of other volumes, this is indicated by the volume number shown in bold text. So ``\dsiwgExtRef{Chapter}{2}{bkm:activities}'' refers to chapter \ref*{Part2-bkm:activities} in volume 2.
