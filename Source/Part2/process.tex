...
Links between the process objectives and the assurance principles are described in \dsiwgExtRef{Chapter}{1}{Part1-bkm:objectives}. The
...
Further examples of system lifecycles are given in \dsiwgExtRef{Chapter}{3}{Part3-bkm:lifecycle}.
