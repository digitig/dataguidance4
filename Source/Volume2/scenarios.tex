...
Table \ref{tab:Scenarios} identifies several scenarios under which it might be useful to recognise data as safety significant.
...
\begin{longtable}{|C{\dsiwgColumnWidth{0.06}}|L{\dsiwgColumnWidth{0.17}}|L{\dsiwgColumnWidth{0.77}}|}
	...
	\label{tab:Scenarios}
	\\\hline\TableHeadColourC{No.} & \TableHeadColour{Name} & \TableHeadColour{Description} \\\hline
	\endfirsthead
	...
	\endfoot\endlastfoot
	\hline
	\multicolumn{3}{|c|}{\textbf{Scenarios with Systems Using Data}}\\\hline
	S-0 & %
	...
	\hline
	\multicolumn{3}{|c|}{\textbf{Development/Engineering Data}}\\
	\hline
	...
	\hline
	\multicolumn{3}{|c|}{\textbf{Tool/Transforming Data}}\\
	\hline
