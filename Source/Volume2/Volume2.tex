...
\externaldocument[Part1-]{../Volume1/Volume1}
\externaldocument[Part3-]{../Volume3/Volume3}
...
{%
  ...
  Title={Data Safety Guidance Vol. 2 - Version 4.0},%
}}
...
\include{interactions_report}
\include{unintended_behaviours}
