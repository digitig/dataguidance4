...
%
%================================================================================
\chapter{Incidents and Accidents} \label{bkm:accidents}
...
\dsiwgTextBF{Note:} The analysis presented here has no legal standing whatsoever. The purpose of this section is not to discredit, contradict or undermine any existing accident or incident analysis; the aim is simply to view these incidents and accidents from a data perspective. Where possible accident reports have been referenced with the role of data highlighted. All references have been taken at face value and not independently verified.
...
\begin{longtable}{|C{\dsiwgColumnWidth{0.07}}|L{\dsiwgColumnWidth{0.43}}|L{\dsiwgColumnWidth{0.07}}|L{\dsiwgColumnWidth{0.43}}|}
  ...
  \hline
    ...
    \ref{bkm:inacc:mac991} & A320-214 Catania incident September 2025 &
    ...
    %%%
    \ref{bkm:inacc:poncheon} & Inadvertent bombing of Poncheon civilian area &
    ...
    %%%
    \ref{bkm:incacc:log4j} & \multicolumn{3}{l|}{Java log4j Library Vulnerability}\\
    \hline
    %%%
    ...
    %%%
    \ref{bkm:inacc:tandem} & Tandem Insulin Pump &
...
\begin{longtable}{|C{\dsiwgColumnWidth{0.07}}|L{\dsiwgColumnWidth{0.16}}|L{\dsiwgColumnWidth{0.37}}|L{\dsiwgColumnWidth{0.14}}|L{\dsiwgColumnWidth{0.1}}|L{\dsiwgColumnWidth{0.15}}|}
  ...
  \label{tab:Incidents}
  \\\hline\TableHeadColourC{Ref.} & \TableHeadColour{Title} & \TableHeadColour{Summary} & \TableHeadColour{Domain} & \TableHeadColour{Year} & \TableHeadColour{\index{Data Property}Data Property}\\\hline
  \endfirsthead
  \caption[]{Incidents and accidents (continued)}
  \\\hline\TableHeadColourC{Ref.} & \TableHeadColour{Title} & \TableHeadColour{Summary} & \TableHeadColour{Domain} & \TableHeadColour{Year} & \TableHeadColour{\index{Data Property}Data Property}\\\hline
  \endhead
  ...
  \hline
  %
  \ref{bkm:inacc:tandem} &%
  	Tandem Insulin Pump\index{Tandem Insulin Pump} &%
  	Excessive Bluetooth\index{Bluetooth} data downloads caused battery failure\index{Battery Failure}. &%
  	Medical &%
  	2024 &%
  	\Gls{goldilocks}\index{Goldilocks Property}\index{Data Property!Goldilocks}\\
  	\hline
  \ref{bkm:inacc:poncheon} &%
  Poncheon Bombing &%
  Incorrect entry of target coordinates during a live-fire exercise led to the bombing\index{Bombing} of a civilian area. &
  Air (Defence) &%
  2025 &%
  \Gls{integrity}\index{Integrity Property}\\
  \hline
  \ref{bkm:inacc:mac991} &%
  A320-214 Catania incident\index[locationidx]{Italy!Catania} &%
  Failure to enter takeoff parameters into the \gls{fms} contributed to an unexpected loss of altitude on takeoff.&%
  Flight&%
  2025 &%
  \Gls{completeness}\index{Completeness Property}\index{Data Property!Completeness}\\
  \hline
  \ref{bkm:incacc:horizon} &%
  Post Office Horizon System\index[locationidx]{United Kingdom}&%
  Non-atomic transactions and other errors in accounting software lead to false prosecutions, lost livelihoods, and suicides. &%
  Accountancy &%
  1999 &%
  \Gls{integrity}\index{Integrity Property}, \gls{completeness}\index{Completeness Property}\index{Data Property!Completeness}, \gls{traceability}\index{Traceability Property}, \gls{verifiability}\index{Verifiability Property}, \gls{history}\index{History Property}\index{Data Property!History}\\ 
  ...
  %
  \hline
  \ref{bkm:incacc:agincourt} &%
  Battle of Agincourt &%
  French misconceptions about English longbow led to devastating losses &%
  Defence &%
  1415 &%
  \Gls{integrity}\index{Integrity Property}, \gls{completeness}\index{Completeness Property}\index{Data Property!Completeness},
  \gls{accuracy}\index{Accuracy Property}\index{Data Property!Accuracy}, \gls{fidelity}\index{Fidelity / Representation Property},
  \gls{timeliness}\index{Timeliness Property}\index{Data Property!Timeliness}\\
  %
  \hline
  \ref{bkm:incacc:geminiV} & Gemini V\index{Gemini V} &
  Erroneous `` schoolchild knowledge'' that Earth rotates 360$^\circ$ per day sends spacecraft off course
  &
  Space & 1965 & \index{Accuracy Property}\index{Data Property!Accuracy}\Gls{accuracy},
  \index{Traceability Property}\index{Data Property!Traceability}\gls{traceability},
  \index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity}\\
  \hline
  %
  ...
  \index{Consistency!Property}\index{Data Property!Consistency}\gls{consistency},
  \index{Aliasing Property}\gls{aliasing}\\
  \hline
  %
    ...
    Medical & 2021 & \index{Integrity Property}\index{Data Property!Integrity}\Gls{integrity}, \index{Accuracy Property}\index{Data Property!Accuracy}\gls{accuracy}, \gls{traceability}, \gls{verifiability}\index{Verifiability Property}\\
    \hline
    ...
    Medical & 2020 & \index{Integrity Property}\index{Data Property!Integrity}\Gls{integrity}, \index{Completeness Property}\index{Data Property!Completeness}\gls{completeness}, \gls{timeliness}\index{Timeliness Property}\index{Data Property!Timeliness}, \index{Availability Property}\index{Data Property!Availability}\gls{availability}, \index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity}\\
    \hline
	\ref{bkm:incacc:737max8} & Boeing 737 MAX~8 crashes &
	On two occasions a single faulty \gls{aoa} sensor repeatedly commanded the nose down,
        leading to the aircraft flying into the sea / ground
	& Air & 2018 \& 2019 & \index{Integrity Property}\index{Data Property!Integrity}\Gls{integrity}, \index{Completeness Property}\index{Data Property!Completeness}\gls{completeness}, \index{Accuracy Property}\index{Data Property!Accuracy}\gls{accuracy}, \index{Availability Property}\index{Data Property!Availability}\gls{availability}, \gls{verifiability}\index{Verifiability Property}, \index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity}\\ 
	\hline
    ...
    & Space & 2017 & \index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\Gls{fidelity}, \index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}, \gls{verifiability}\index{Verifiability Property} \\
    \hline
	\ref{bkm:incacc:cambrian} & Cambrian Line Data Loss &
	Speed restriction data failed to be passed to trains, placing pedestrians on level crossings at risk.
	& Rail & 2017 & \index{Availability Property}\index{Data Property!Availability}\gls{availability}, \gls{history}\index{History Property}\index{Data Property!History} \\ 
	\hline
	\ref{bkm:incacc:irishsar} & Loss of Irish rescue Helicopter & At the time of writing, the investigation\index{Investigation!Incident / Accident} is continuing; possible controlled flight into terrain; possible issues with terrain / obstacle \glspl{database}. Four fatalities. & Air & 2017 & \index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\Gls{fidelity}, \index{Completeness Property}\index{Data Property!Completeness}\gls{completeness}, \index{Accuracy Property}\index{Data Property!Accuracy}\gls{accuracy} \\
	\hline
	\ref{bkm:incacc:schiaparelli} & Loss of Schiaparelli Mars Lander & High rates led to the saturation of the \gls{imu}; the lander prematurely believed it was on the ground and released its parachute; the lander was lost. The high rates should have been expected, but were not due to modelling deficiencies. & Space & 2016 & \index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\Gls{fidelity}, \index{Integrity Property}\index{Data Property!Integrity}\gls{integrity} \\
	\hline
	\ref{bkm:incacc:comintercept} & Interception of Communications & Incorrect data was disclosed during an investigation\index{Investigation!Criminal} into indecent images. A welfare check was delayed on a child believed to be in crisis. & Policing & 2015 & \index{Integrity Property}\index{Data Property!Integrity}\Gls{integrity} \\ 
	\hline
	\ref{bkm:incacc:a400m} & A400M Torque Calibration Parameters & A software update apparently wiped the engine torque control parameters. Aircraft crash; four fatalities. & Air (Defence) & 2015 & \index{Completeness Property}\index{Data Property!Completeness}\Gls{completeness} \\
	\hline
	\ref{bkm:incacc:subtrawler} & Royal Navy Submarine, Trawler \dsiwgTextIT{Karen}\index{Trawler Karen} & A royal Navy submarine snagged the fishing gear of the trawler \dsiwgTextIT{Karen}. The trawler was dragged backwards at about seven knots and suffered structural damage. & Maritime & 2015 & \Gls{resolution}, \index{Integrity Property}\index{Data Property!Integrity}\gls{integrity} \\
	\hline
	\ref{bkm:accinc:turkisha330} & Turkish Airlines A330 & Inaccurate navigation data, relating to runway location, led to touchdown with left main gear off the paved surface. Aircraft written off. & Air & 2015 & \index{Accuracy Property}\index{Data Property!Accuracy}\Gls{accuracy}, \gls{timeliness}\index{Timeliness Property}\index{Data Property!Timeliness}, \gls{verifiability}\index{Verifiability Property} \\
	\hline
	\ref{bkm:incacc:dallasebola} & Dallas Hospital Ebola Incident & A man suffering from Ebola was mistakenly sent home from a Dallas hospital. He later returned to hospital, was diagnosed but died; two nurses contracted Ebola but survived. & Medical & 2014 & \index{Completeness Property}\index{Data Property!Completeness}\Gls{completeness}, \gls{format}\index{Format Property}\index{Data Property!Format} \\
	\hline
	\ref{bkm:incacc:qantastakeoff} & Qantas \index{Boeing 737}Boeing 737 Take-Off & Two independent and inadvertent data entry\index{Data!Entry} errors meant weight used when calculating take-off performance was 10 tonnes less than actual weight. Tail strike. & Air & 2014 & \index{Integrity Property}\index{Data Property!Integrity}\Gls{integrity}, \gls{verifiability}\index{Verifiability Property} \\
	\hline
	\ref{bkm:incacc:qantasloading} & Qantas \index{Boeing 737}Boeing 737 Loading & Default settings meant that children were incorrectly recorded as adults, resulting in incorrect aircraft weight and balance. Take-off safety speed was exceeded by about 25 knots. & Air & 2014 & \index{Completeness Property}\index{Data Property!Completeness}\Gls{completeness}, \index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity}\\
	\hline
	\ref{bkm:incacc:navscor} & Grounding of \dsiwgTextIT{Navigator Scorpio} & The \dsiwgTextIT{Navigator Scorpio} was sailing with out-of-date charts, the planned route was not checked and positional fixes were not taken as often as required. The vessel was grounded, but refloated on the rising tide, with no damage. After the event, false \gls{information} was added to the navigation chart. & Maritime & 2014 & \gls{timeliness}\index{Timeliness Property}\index{Data Property!Timeliness}, \gls{verifiability}\index{Verifiability Property} \\
	\hline
	\ref{bkm:incacc:mq9reaper} & Loss of MQ-9 reaper & The \gls{gcs} station was misconfigured following a change from MQ-1 to MQ-9 operations. The misconfiguration was not spotted. It caused any throttle position aft of full forward to command negative thrust. The aircraft decelerated below stall speed and impacted ground in unpopulated area. & Air (Defence) & 2012 & \index{Consistency!Property}\index{Data Property!Consistency}\Gls{consistency}, \gls{verifiability}\index{Verifiability Property} \\
	\hline

        \ref{bkm:incacc:737-33A} & \index{Boeing 737}Boeing 737-33A at Chambery Airport, France & Misuse of Electronic Flight Bag results in tail strike & Air & 2012 &\Gls{timeliness}\index{Timeliness Property}\index{Data Property!Timeliness}, \gls{suppression}\index{Suppression Property}\index{Data Property!Suppression}, \gls{lifetime}\index{Lifetime Property}\index{Data Property!Lifetime} \\
        \hline
        
	\ref{bkm:incacc:hermes450} & Loss of Hermes 450 & While attempting an automatic landing the \gls{uas} self-aborted. This abort was due to an incorrect set-up parameter that had been loaded by the crew. The crew elected to intervene rather than let the \gls{uas} self-recover. The air vehicle hit a new, unoccupied hangar; it was ultimately deemed ``non-repairable''. & Air (Defence) & 2011 & \index{Integrity Property}\index{Data Property!Integrity}\Gls{integrity} \\
	\hline
	\ref{bkm:incacc:advocatelutheran} & Advocate Lutheran Hospital & An infant boy died after a series of medical errors: incorrect \gls{information} was entered into an electronic intravenous order; automatic alerts had been turned off; and a bag was mislabelled. & Medical & 2010 & \index{Integrity Property}\index{Data Property!Integrity}\Gls{integrity}, \gls{verifiability}. \\
	\hline
	\ref{bkm:incacc:sichemosprey} & Grounding of \dsiwgTextIT{Sichem Osprey} & Anti-collision radar thresholds were apparently set incorrectly; there were also sizeable discrepancies between positions plotted on a chart and those displayed on the radar. The vessel grounded at more than 16 knots; no pollution occurred. & Maritime & 2010 & \index{Integrity Property}\index{Data Property!Integrity}\Gls{integrity}, \index{Accuracy Property}\index{Data Property!Accuracy}\gls{accuracy} \\
	\hline
	\ref{bkm:incacc:cootamundra} & Near Collision of Trains, Cootamundra\index[locationidx]{Australia!New South Wales!Cootamundra} & Following a signalling\index{Signalling, Railway} system design error, a passenger train had to unexpectedly apply its brakes; it stopped just 5 m short of a goods train. & Rail & 2009 & \index{Integrity Property}\index{Data Property!Integrity}\Gls{integrity}, \index{Completeness Property}\index{Data Property!Completeness}\gls{completeness} \\
	\hline
	...
	\hline
	\ref{bkm:incacc:canterbury} & Grounding of \dsiwgTextIT{The Pride of Canterbury} & An unapproved \gls{ecs} was apparently being used as the primary means of navigation for the passenger ferry \dsiwgTextIT{The Pride of Canterbury}. Due to user settings a charted wreck would not have been displayed on this system. The vessel grounded on the wreck, causing severe damage to her port propeller system. & Maritime & 2008 & \index{Accuracy Property}\index{Data Property!Accuracy}\Gls{accuracy}, \index{Completeness Property}\index{Data Property!Completeness}\gls{completeness}, \gls{intended_destination} \\
	\hline
	\ref{bkm:incacc:lot282} & LOT Flight 282 & Incorrect data input to the Flight Management System, `E' rather than `W', meant loss of instruments. Aircraft had to return to \gls{lhr}. & Air & 2008 & \index{Integrity Property}\index{Data Property!Integrity}\Gls{integrity}, \index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity} \\
	\hline
        ...
        Maritime & 2007 & \index{Integrity Property}\index{Data Property!Integrity}\Gls{integrity}, \gls{verifiability}\index{Verifiability Property}, \index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity} \\
        \hline
        \ref{bkm:incacc:comair5191} & Comair Flight 5191 & Inaccurate (out-of-date) aerodrome charts led to take-off being attempted from the wrong runway. Aircraft overran the runway; 49 fatalities. & Air & 2006 & \Gls{timeliness}\index{Timeliness Property}\index{Data Property!Timeliness}, \index{Completeness Property}\index{Data Property!Completeness}\gls{completeness} \\
	\hline
	\ref{bkm:incacc:uberlingen} & \"Uberlingen Mid-Air Collision & Contradictory advice from \gls{tcas} and an air traffic controller led to a mid-air collision between two \gls{tcas}-equipped aircraft. 71 fatalities. & Air & 2002 & \index{Consistency!Property}\index{Data Property!Consistency}\Gls{consistency}, \index{Availability Property}\index{Data Property!Availability}\gls{availability}, \gls{timeliness}\index{Timeliness Property}\index{Data Property!Timeliness} \\
	\hline
	\ref{bkm:incacc:fortdrum} & Fort Drum Artillery Incident & Movement of an artillery site led to errors in targeting. Artillery shells were fired more than a mile off target: 2 soldiers killed; 13 injured. & Defence & 2002 & \index{Integrity Property}\index{Data Property!Integrity}\Gls{integrity}, \gls{verifiability}\index{Verifiability Property} \\
	\hline
	\ref{bkm:incacc:washprison} & Early release from Washington State Prison & A software update led to miscalculation of the time an inmate was due to serve in prison. Although the results of the calculation could easily be checked, the problem persisted for 13 years and over 2,000 offenders were released early. & Policing & 2002 & \index{Integrity Property}\index{Data Property!Integrity}\Gls{integrity}, \gls{verifiability}\index{Verifiability Property} \\
	\hline
	\ref{bkm:incacc:marsclimate} & Mars Climate Orbiter & A mismatch in the units used by two software teams led to errors in the Flight Management System and, ultimately, the loss of a multi-million dollar space mission. & Space & 1998 & \index{Consistency!Property}\index{Data Property!Consistency}\Gls{consistency} \\
	\hline
	\ref{bkm:incacc:nimitzhill} & Crash into Nimitz Hill, Guam & \Gls{cfit}; the ground-based \gls{msaw} designed to alert air traffic controllers had been inhibited. 228 fatalities; 26 serious injuries. & Air & 1997 & \index{Continuity Property}\index{Data Property!Continuity}\Gls{continuity}, \index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity}\\
	\hline
        \ref{bkm:incacc:sanbernardino} &
        ...
        Rail & 1989 & \index{Integrity Property}\index{Data Property!Integrity}\Gls{integrity}, \index{Completeness Property}\index{Data Property!Completeness}\gls{completeness}, \index{Accuracy Property}\index{Data Property!Accuracy}\gls{accuracy}, \gls{timeliness}\index{Timeliness Property}\index{Data Property!Timeliness}, \gls{verifiability}\index{Verifiability Property}, \index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity}, \gls{lifetime}\index{Lifetime Property}\index{Data Property!Lifetime} \\
        \hline
...
\section{Tandem Insulin Pump}\label{bkm:inacc:tandem}\index{Tandem Insulin Pump}
The Tandem insulin pump by Tandem Diabetes Care Inc. is a device for the subcutaneous delivery of insulin\index{Insulin} to for the treatment of diabetes\index{Diabetes} mellitus. There is a mobile app for monitoring and limited control of the pump, t:connect,  available on iOS and Android.

In March 2024, Tandem Diabetes Inc. issued a recall of version 2.7 of the iOS version of the mobile app. A software issue was causing the app to crash and relaunch automatically, leading to excessive Bluetooth communication and pump battery depletion. A depleted battery may cause the insulin pump to shut down, leading to under delivery of insulin and possible hyperglycemia. The Food and Drug Administration (FDA) identified this as a Class I recall, the most serious type of recall. Over 200 injuries have been identified as associated with the recall.\cite{citation:tandem_initial}.

In August 2024, Tandem Diabetes Inc. issued a recall of version 2.7.1 of the software, which had been intended to remedy the issue, because the same issue was occurring with the new version of the software and there had been 107 reports of adverse events, two requiring hospitalisation\cite{citation:tandem_subsequent}. Users were advised\cite{citation:tandem_recall} to:
\begin{itemize}
	\item Continue using your Tandem pump and t:connect mobile app as described in the User Guide:
	\begin{itemize}
		\item Charge the pump for a short time every day (10 to 15 minutes) to avoid frequent full battery discharges.
		\item Monitor pump battery levels closely to ensure the pump is at or near full charge before going to sleep to help prevent pump shutdown.
		\item Always carry back-up supplies.
	\end{itemize}
	\item If a low battery alert is received, Tandem strongly recommends charging the device as soon as possible.
\end{itemize}

No software upgrade to remedy the issue was available at that time. 

\Gls{data property} involved: Because the failure was caused by excessive data downloads, this relates to the \gls{goldilocks} property.
\section{Poncheon Bombing}\index[locationidx]{South Korea!Poncheon}\label{bkm:inacc:poncheon}
On the 6 March 2025, two South Korean KF-16 fighters released four MK-82 bombs each on a civilian area on Poncheon, South Korea, during a live-fire military exercise. The bombing\index{Bombing} injured nearly 30 people, 2 seriously, and caused extensive property damage. Initial investigations found the pilot of one of the KF-16s entered the wrong coordinates for a bombing site.\cite{citation:korea_bombing}

\Glspl{data property} involved: Incorrrect coordinates indicates a failure of the \gls{integrity} property. The reasons for the incorrect entry do not appear to be public; there may or may not be other properties contributing to this \gls{integrity} failure, such as \gls{consistency}, \gls{format}, \gls{fidelity} and \gls{clarity}, but this is not known to the authors at the time of writing.


\section{A320-214 Catania incident September 2025}\index[locationidx]{Italy!Catania}\label{bkm:inacc:mac991}
On September 20, 2025, an Air Arabia Maroc Airbus A320-214, registration CN-NML, took off from Catania Fontanarossa International Airport in Sicily for a positioning flight. Shortly after takeoff, the aircraft experienced an unexpected descent, causing multiple ground proximity warning alerts. The crew initiated a successful recovery manoeuvrer and continued the flight without incident. The minimum recorded altitude was 41ft  (12.5m). The operator reported the descent to the \gls{ansv} which classified it as a serious incident and initiated a safety investigation.

The preliminary investigation indicates that the takeoff performance data was not entered into the \gls{fms}. The \gls{fms} had not been fitted with an upgrade which would have given a warning in this case. Had the takeoff performance data been entered into the \gls{fms}, the \gls{fms} would have maintained the reference speed during the climb. However, without the takeoff performance data, the \gls{fms} engaged vertical speed mode and attempted a vertical speed profile derived from the initial climb rate, which actually led to a descending profile.

At the time of writing, the reason for the performance data not being entered has not been identified. Some other crew actions are as yet unexplained. The omission of the performance data does, however, seem to have been a significant contribution to this serious incident. \cite{citation:inacc:mac991}, \cite{citation:inacc:mac991:prelim}.

\Glspl{data property} involved: The performance data not being entered amounted to a loss of the {\index{Completeness Property}\index{Data Property!Completeness}\gls{completeness}}.

\section{Post Office Horizon System}\index[locationidx]{United Kingdom}\label{bkm:incacc:horizon}
...
The false prosecutions resulting from the faults in the Horizon system are at the time of writing subject to a public inquiry. The \gls{ccrc} described the prosecutions as ``the most widespread miscarriage of justice the \gls{ccrc} has ever seen and represents the biggest single series of wrongful convictions in British legal history''  \cite{citation:horizon_ccrc}.
...
\end{itemize}
  ...
  % Agincourt - start
  %
\section{Battle of Agincourt}\index[locationidx]{France!Agincourt}\label{bkm:incacc:agincourt}
  ...
  \index{Integrity Property}\index{Data Property!Integrity}\gls{integrity} and
  \index{Completeness Property}\index{Data Property!Completeness}\gls{completeness}.
  ...
  \index{Accuracy Property}\index{Data Property!Accuracy}\gls{accuracy} and the
  \dsiwgTextIT{\index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity}} property.
  ...
  \dsiwgTextIT{\gls{timeliness}\index{Timeliness Property}\index{Data Property!Timeliness} property}.
...
\end{itemize}
  ...
  % Agincourt - end
  %
\section{Gemini V}\label{bkm:incacc:geminiV}
...
\Glspl{data property} involved: The approximation was a loss of the \index{Accuracy Property}\index{Data Property!Accuracy}\gls{accuracy} property.
Its introduction resulted from a lack of consideration of celestial movement,
and so could potentially also be regarded as a loss of both the \dsiwgTextIT{\index{Traceability Property}\index{Data Property!Traceability}\gls{traceability}} and \dsiwgTextIT{\index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity}} properties.
...
\section{What3Words}\label{bkm:incacc:w3w}
...
\Glspl{data property} involved: The ambiguities can lead to loss of \dsiwgTextIT{\index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}},
whilst the resulting distortion of world view is a loss of \dsiwgTextIT{\index{Consistency!Property}\index{Data Property!Consistency}\gls{consistency}},
...
\section{Java\index{Java} log4j\index{Log4j} Library Vulnerability}\label{bkm:incacc:log4j}
...
\Gls{data property} involved: \dsiwgTextIT{\index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}.}
...
\section{Immensa\index{Immensa} False Negative Covid-19\index{Covid-19} \index{PCR}\index{PCR} Tests} \label{bkm:incacc:immensa}
...
\Glspl{data property} involved: \index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}, \index{Accuracy Property}\index{Data Property!Accuracy}\gls{accuracy} and possibly \dsiwgTextIT{\gls{traceability}} and \gls{verifiability}\index{Verifiability Property}.
...
\section{Covid-19\index{Covid-19} Test Results Silently Deleted by Excel\index{Excel}} \label{bkm:incacc:covidexcel}
...
Finally, it is an example of where an error is known to the system, but not reported (adequately) to the user (Data Category: dynamic\index{Dynamic Data}; \index{Data Property}properties lost: \gls{timeliness}\index{Timeliness Property}\index{Data Property!Timeliness}, \index{Availability Property}\index{Data Property!Availability}\gls{availability}).
...
\section{\index{Boeing 737}Boeing 737 MAX 8 Crashes} \label{bkm:incacc:737max8}
...
\Gls{mcas}\index{MCAS} did not compare data from the two sensors in order to detect a discrepancy between them, and hence indicate that the sensor data was not trustworthy (data category: {dynamic data}; properties lost: \index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}, \index{Accuracy Property}\index{Data Property!Accuracy}\gls{accuracy}, \index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity}; \glspl{mitigation}\index{Mitigation} unused: redundancy). Furthermore, the function (outside MCAS\index{MCAS}) to report a discrepancy between the sensors to the pilots was not enabled, reducing the crew's ability to respond appropriately (data category: dynamic\index{Dynamic Data}; \index{Data Property} lost: \index{Availability Property}\index{Data Property!Availability}\gls{availability}).

Several other data-safety-related failures can also be found in the report on flight 610:

\begin{itemize}
    \item The \gls{mcas}\index{MCAS} system was not described in the pilot's manual and training\index{Training!Personnel} materials (Data Category: Staffing\index{Staffing Data}, \index{Data Property}Properties lost: \index{Availability Property}\index{Data Property!Availability}\gls{availability})
    \item There was no indication to the pilots that \gls{mcas}MCAS\index{MCAS} was active (Data Category: Dynamic\index{Dynamic Data}; \index{Data Property}Properties lost: \dsiwgTextIT{\index{Availability Property}\index{Data Property!Availability}\gls{availability}}).
    \item The \gls{aoa} sensor fitted to flight 610 was incorrectly calibrated during a previous repair,
      ...
      (Data Category: Justification\index{Justification Data}; \index{Data Property}Properties lost: \dsiwgTextIT{\index{Availability Property}\index{Data Property!Availability}\gls{availability}, \index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity}, \gls{verifiability}\index{Verifiability Property}}).
    \item The evidence of the testing of the \gls{aoa} sensor after fitting to flight 610 by the maintenance crew was erroneous (Data Category: Justification\index{Justification Data}; Properties lost: \dsiwgTextIT{\index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}, \index{Availability Property}\index{Data Property!Availability}\gls{availability}, \gls{verifiability}\index{Verifiability Property}})
    \item 31 pages were missing from the maintenance log-book for flight 610, including the records of the testing of the \gls{aoa} sensor after fitting to the aircraft (Data Category: Asset\index{Asset Data}; \index{Data Property}Properties lost: \dsiwgTextIT{\index{Completeness Property}\index{Data Property!Completeness}\gls{completeness}, \index{Availability Property}\index{Data Property!Availability}\gls{availability}, \gls{verifiability}\index{Verifiability Property}})
...
%    \item The ability of MCAS to detect a faulty sensor was only tested with faulty sensors giving a value 24° higher than measured (Data Category: Verification; Properties lost: \dsiwgTextIT{Completeness}).
    \item During the previous flight of the aircraft on flight 610, the pilots experienced repeated activation of the stick shaker, and other alarms, which were caused by the faulty \gls{aoa} sensor.
      However they did not fully report all the issues in the flight logs, and so the maintenance crew's remediation activities did not lead them to suspect an issue with the sensor. (Data Category: Performance\index{Performance Data}, \index{Data Property}Properties lost: \dsiwgTextIT{\index{Availability Property}\index{Data Property!Availability}\gls{availability}})
    \item During flight testing, \gls{adaptation data}\index{Adaptation Data} was changed to give \gls{mcas}\index{MCAS} more authority, without a new safety impact assessment (Data Category: Adaptation\index{Adaptation Data}; \index{Data Property}Properties lost: \dsiwgTextIT{\gls{verifiability}\index{Verifiability Property}}).
\end{itemize}
...
\section{Loss of Soyuz-2.1b\index{Soyuz} Rocket Carrying Meteor-M\index{Meteor-M} 2-1 Weather Satellite} \label{bkm:incacc:soyuz}
...
This is an example of a problem with data in the Adaptation category\index{Adaptation Data}, which did not map correctly to the real-world entity that it was modelling, and hence lost the \dsiwgTextIT{\index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity}} property. Other properties that were lost include \dsiwgTextIT{\index{Integrity Property}\index{Data Property!Integrity}\gls{integrity} and \gls{verifiability}\index{Verifiability Property}.}
...
%
\section{Cambrian Line\index{Cambrian Line} Data Loss} \label{bkm:incacc:cambrian}
...
This incident highlights the importance of the \dsiwgTextIT{\index{Availability Property}\index{Data Property!Availability}\gls{availability}} \index{Data Property}\gls{data property}, as the data had been silently unavailable to trains. In addition, much of the digital audit trail relating to the failure was lost during repeated attempts to correct the problem and get the rail network running again, a loss of the \dsiwgTextIT{\gls{history}\index{History Property}\index{Data Property!History}} \index{Data Property}\gls{data property}.
...
\section{Loss of Irish Rescue Helicopter} \label{bkm:incacc:irishsar}
...
This incident potentially illustrates the importance of the \dsiwgTextIT{\index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity}} and \dsiwgTextIT{\index{Completeness Property}\index{Data Property!Completeness}\gls{completeness}} \index{Data Property}\glspl{data property}, with respect to the \gls{egpws} \gls{database}, and the \index{Accuracy Property}\index{Data Property!Accuracy}\gls{accuracy} \gls{data property}, with respect to the route guides.
...
\section{Loss of Schiaparelli Mars Lander}\index{Schiaparelli Mars Lander}\index[locationidx]{Mars!Lander, Schiaparelli|see{Schiaparelli Mars Lander}} \label{bkm:incacc:schiaparelli}
...
This incident illustrates the importance of the \dsiwgTextIT{\index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity}} \gls{data property}, with respect to the modelling, and the \dsiwgTextIT{\index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}} \gls{data property}, with respect to the persistence time of the saturation flag.
...
\section{Interception of Communications} \label{bkm:incacc:comintercept}
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}} \gls{data property}. It also shows the applicability of data safety guidance to areas that are not traditionally encompassed by safety engineering.
...
\section{A400M\index{Airbus!A400M}, Torque Calibration Parameters\index{Torque Calibration}} \label{bkm:incacc:a400m}
...
This accident highlights the importance of the \dsiwgTextIT{\index{Completeness Property}\index{Data Property!Completeness}\gls{completeness}} \gls{data property}, specifically with respect to the torque calibration\index{Torque Calibration} parameters.
...
\section{RN Submarine\index{Submarine}, Trawler Karen\index{Karen|see{Trawler Karen}}\index{Trawler Karen}} \label{bkm:incacc:subtrawler}
...
This incident highlights the importance of the \dsiwgTextIT{\gls{resolution}} \gls{data property}, specifically with regards to resolving a trawler and a merchant vessel. It also highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}}, specifically with regards to the \gls{information} provided from the sonar\index{Sonar} team to the command team. 
...
\section{Turkish Airlines\index{Turkish Airlines} A330\index{Airbus!A330-303}} \label{bkm:accinc:turkisha330}
During March 2015, an Airbus A330-303, operated by THY Turkish Airlines, suffered a runway excursion accident upon landing at Kathmandu-Tribhuvan\index[locationidx]{Nepal!Kathmandu!Kathmandu-Tribhuvan Airport} (KTM)\index{KTM|see{T\"urkiye, Kathmandu-Tribhuvan in location index}}.

Flight TK726 was a regular passenger service from Istanbul-Atat{\"u}rk\index[locationidx]{T\"urkiye!Istanbul!Istanbul-Atat{\"u}rk International Airport} (IST)\index{IST|see{Istanbul-Atat{\"u}rk in location index}} to Kathmandu, Nepal\index[locationidx]{Nepal!Kathmandu}. The flight was the first international flight to arrive that morning. After descending from cruising altitude, it entered a holding pattern. It was subsequently cleared for a \gls{vor} / \gls{dme} approach to runway 02. 
...
\begin{itemize}
  ...
  \item ``Civil Aviation Authority of Nepal must ensure that raw \gls{information aeronautical} / data are provided by the aerodrome authorities taking into account of its \index{Accuracy Property}\index{Data Property!Accuracy}accuracy and \index{Integrity Property}\index{Data Property!Integrity}\gls{integrity} requirements for \gls{aeronautical data} as specified by \gls{icao} Annex 15 and its \ecapitalisewords{\glsentrytext{information aeronautical}} Service Manual.''
\end{itemize}

This incident highlights the importance of three \glspl{data property}: \index{Accuracy Property}\index{Data Property!Accuracy}\gls{accuracy}; \dsiwgTextIT{\gls{timeliness}\index{Timeliness Property}\index{Data Property!Timeliness}}; and \dsiwgTextIT{\gls{verifiability}}\index{Verifiability Property}. All of these apply to data describing the runway's location.
...
\section{Dallas Hospital Ebola Incident\index{Ebola}} \index{Dallas Hospital}\index[locationidx]{USA!Texas!Dallas}\label{bkm:incacc:dallasebola}
...
This incident highlights the importance of the \dsiwgTextIT{\index{Completeness Property}\index{Data Property!Completeness}\gls{completeness}} and \dsiwgTextIT{\gls{format}}{\index{Format Property}\index{Data Property!Format}} \glspl{data property}, in that \gls{information} about the Ebola\index{Ebola} outbreak was apparently either not available, or not available in a usable form, to decision makers.
...
\section{Qantas Boeing 737 Take-Off} \index{Qantas}\index{Boeing 737}\label{bkm:incacc:qantastakeoff}
...
The \gls{atsb} also identified that the \index{Qantas}Qantas procedure for conducting a check of the Vref40 speed could be misinterpreted. This negated the effectiveness of that check as a defence for identifying data entry\index{Data!Entry} errors. In this case, uncorrected errors affected the \index{Integrity Property}\index{Data Property!Integrity}\gls{integrity} of the data used to calculate take-off parameters.

This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}} and \dsiwgTextIT{\gls{verifiability}}\index{Verifiability Property} \glspl{data property}, with respect to the data used to calculate take-off performance data\index{Performance Data}.
...
\section{Qantas Boeing 737 Loading} \index{Qantas}\index{Boeing 737}\label{bkm:incacc:qantasloading}
...
This incident demonstrates the importance of the \dsiwgTextIT{\index{Completeness Property}\index{Data Property!Completeness}\gls{completeness}} data property (i.e., ensuring that the mandatory ``Gender Description'' field was completed) and the \dsiwgTextIT{\index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity}} \gls{data property} (i.e., ensuring the calculated aircraft loads and balances reflect the real situation). It also illustrates some potential difficulties associated with the use of default data.
...
\section{Grounding of Navigator Scorpio\index{Navigator Scorpio}} \label{bkm:incacc:navscor}
...
This incident highlights the importance of the \dsiwgTextIT{\gls{timeliness}\index{Timeliness Property}\index{Data Property!Timeliness}} \gls{data property}, with respect to both the additional North Sea charts and the master's check of the passage plan.
...
\section{Loss of MQ-9 reaper\index{MQ-9 Reaper}} \label{bkm:incacc:mq9reaper}
...
\section{Boeing 737-33A at Chambery Airport, France} \index{Boeing 737}\index[locationidx]{France!Chambery}\label{bkm:incacc:737-33A} 
...
It is often recognized that data must be up to date, but the explicit need to prevent the use of old data can be omitted from the \index{Safety Requirement}safety requirements. This incident illustrates the importance of the properties \dsiwgTextIT{\gls{timeliness}\index{Timeliness Property}\index{Data Property!Timeliness}, \gls{suppression}\index{Suppression Property}\index{Data Property!Suppression}} and \dsiwgTextIT{\gls{lifetime}\index{Lifetime Property}\index{Data Property!Lifetime}}. 
...
\section{Loss of Hermes 450\index{Hermes 450}} \label{bkm:incacc:hermes450}
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}} \gls{data property}, with respect to the \gls{gtols} data loaded by the crew.
...
\section{Advocate Lutheran Hospital\index{Advocate Lutheran Hospital}} \label{bkm:incacc:advocatelutheran}
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}} and \dsiwgTextIT{\gls{verifiability}} \index{Verifiability Property}\glspl{data property}, for example with regard to: the \gls{information} in the \gls{iv} order; the bag label; and the blood test results.
...
\section{Grounding of Sichem Osprey}\index{Sichem Osprey} \label{bkm:incacc:sichemosprey}
On 10 February 2010 at 0436 (local), the chemical tanker \dsiwgTextIT{Sichem Osprey}\index{Sichem Osprey}, on her way from Panama\index[locationidx]{Panama} to Ulsan\index[locationidx]{South Korea!Ulsan} (South Korea) stranded at more than 16 knots on the north-easterly part of Clipperton Island\index[locationidx]{France!Clipperton Island}. An \gls{oow} and a lookout were on the bridge at the time and no damage had been reported prior to the accident. A 100 metre fore part of the vessel had been grounded. No pollution was observed.
...
This incident highlights the role of the \dsiwgTextIT{\index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}} \gls{data property}, with respect to the chart plots, and the \index{Accuracy Property}\index{Data Property!Accuracy}\gls{accuracy} \gls{data property}, with respect to the alarm thresholds which did not reflect the Captain's wishes.
...
\section{Near Collision of Trains, Cootamundra}\index[locationidx]{Australia!New South Wales!Cootamundra} \label{bkm:incacc:cootamundra}
...
This incident illustrates the importance of the \dsiwgTextIT{\index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}} \gls{data property}, with respect to the control table data, and the \dsiwgTextIT{\index{Completeness Property}\index{Data Property!Completeness}\gls{completeness}} \gls{data property}, with respect to data produced by the testing and the quality control processes.
...
%\clearpage
\section{\protect Cedars-Sinai Medical Center\protect\index{Cedars-Sinai Medical Center} Scanner} \label{bkm:incacc:cedarssinai}
...
\section{Grounding of The Pride of Canterbury\index{Pride of Canterbury}} \label{bkm:incacc:canterbury}
...
This incident highlights the importance of the \index{Accuracy Property}\index{Data Property!Accuracy}\gls{accuracy} \gls{data property}, with regards to the \gls{information} displayed on the electronic chart. It also highlights the importance of the \dsiwgTextIT{\index{Completeness Property}\index{Data Property!Completeness}\gls{completeness}} \gls{data property}, with regards to training\index{Training!Personnel} (and training\index{Training!Personnel} records) and the \dsiwgTextIT{\gls{intended_destination}} \gls{data property}, with regards to the inappropriate use of the \gls{vms} data.
...
\section{LOT Flight 282}\index{LOT Flight 282} \label{bkm:incacc:lot282}
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}} and \dsiwgTextIT{\index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity}} \glspl{data property}, specifically with respect to coordinates.
...
\section{Annabella Container Ship -- Baltic Sea} \index{Annabella}\index[locationidx]{Baltic Sea}\label{bkm:incacc:annabella}
...
\item The \index{Availability Property}\index{Data Property!Availability}\gls{availability} of a reliable and approved loading computer programme is a factor to be considered in determining an appropriate level of manning for vessels on intensive schedules; 
...
This incident involved incorrect data, that could have been identified if the software had highlighted the unusual aspects of the data such as the container dimensions to the operator. From a data perspective, the properties that needed to be maintained were \dsiwgTextIT{\index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}, \gls{verifiability}}\index{Verifiability Property} and \dsiwgTextIT{\index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity}.}
...
\section{Comair Flight 5191}\index{Comair Flight 5191} \label{bkm:incacc:comair5191}
...
Due to a previously unrecognized software problem, any \gls{information} the chart provider received after normal work hours on Fridays was not included in their regular updates. Furthermore, the chart provider modified the Blue Grass Airport chart after the accident to include a note that runway 8/26 is ``daytime \glsxtrshort{vmc}\footnote{\glsxtrlong{vmc}} use only'', even though this \gls{information} had been published since 2001. Additionally there was a local \gls{notam} issued advising of taxiway closures due to construction work. However the crew was not provided with this \gls{information} in their dispatch paperwork.

This incident highlights the importance of the \dsiwgTextIT{\gls{timeliness}\index{Timeliness Property}\index{Data Property!Timeliness}} \gls{data property}, specifically with regards to the charts. The \dsiwgTextIT{\index{Completeness Property}\index{Data Property!Completeness}\gls{completeness}} \gls{data property} is also relevant, given that neither the ``after hours'' changes on Fridays nor the local \gls{notam} were communicated appropriately.
...
\section{\"Uberlingen Mid-Air Collision}\index[locationidx]{Switzerland!\"Uberlingen} \label{bkm:incacc:uberlingen}
...
This incident illustrates the importance of the following \glspl{data property}: \dsiwgTextIT{\index{Consistency!Property}\index{Data Property!Consistency}\gls{consistency}}, with regards to the instructions provided to Flight 2937; \dsiwgTextIT{\index{Availability Property}\index{Data Property!Availability}\gls{availability}}, with regards to \gls{information} from the ground-based optical system; and \dsiwgTextIT{\gls{timeliness}\index{Timeliness Property}\index{Data Property!Timeliness}}, with regards to \gls{information} from the radar system.
...
\section{Fort Drum Artillery Incident} \index[locationidx]{USA!New York!Fort Drum}\label{bkm:incacc:fortdrum}
...
This incident highlights the importance of the \dsiwgTextIT{\index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}} and \dsiwgTextIT{\gls{verifiability}}\index{Verifiability Property} \glspl{data property}, specifically with respect to the location and elevation data.
...
\section{Early Release from Washington State Prison\index{Washington State Prison}} \label{bkm:incacc:washprison}
...
% \clearpage
\section{Mars Climate Orbiter}\index[locationidx]{Mars!Climate Orbiter} \label{bkm:incacc:marsclimate}
...
This incident highlights the importance of the \dsiwgTextIT{\index{Consistency!Property}\index{Data Property!Consistency}\gls{consistency}} \gls{data property}.
...
\section{Crash into Nimitz Hill, Guam \label{bkm:incacc:nimitzhill}}
...
Probable causes of the accident were the captain's failure to adequately brief and execute a non-precision approach and the first officer's and flight engineer's failure to effectively monitor and cross-check this approach. Contributing factors included fatigue and inadequate flight crew training\index{Training!Personnel}.

Another contributing factor was the intentional inhibition by the \gls{faa} of the \gls{msaw} system at Guam International Airport\index[locationidx]{Guam!International Airport}, and the agency's failure to adequately manage the system.
...
This incident illustrates the importance of the \index{Continuity Property}\index{Data Property!Continuity}\gls{continuity}\gls{data property}, with respect to the \gls{msaw} coverage, and the \index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity} \gls{data property},
regarding
...
\section{San Bernardino Derailment and Pipeline Rupture} \index[locationidx]{USA!California!San Bernardino}\label{bkm:incacc:sanbernardino}
...
From the \gls{criticality} of the weight \gls{information}, \index{Safety Requirement!Data!Derived}derived safety requirements could be developed for the various data sources that were used to derive the weight. Such requirements could be expected to highlight the properties of \index{Integrity Property}\index{Data Property!Integrity}\gls{integrity}, \index{Completeness Property}\index{Data Property!Completeness}\gls{completeness}, \index{Accuracy Property}\index{Data Property!Accuracy}\gls{accuracy}, \gls{timeliness}\index{Timeliness Property}\index{Data Property!Timeliness}, \gls{verifiability}\index{Verifiability Property}, \index{Fidelity / Representation Property}\index{Data Property!Fidelity / Representation}\gls{fidelity} and \gls{lifetime}\index{Lifetime Property}\index{Data Property!Lifetime}.
...
\section{Lake Peigneur Drilling Accident} \index[locationidx]{USA!Louisiana!Lake Peigneur}\label{bkm:incacc:peigneur}
